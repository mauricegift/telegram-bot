    ...
    async handleCases(m, { Gifted, text, command }) {
        try {
            switch (command) {
                ...
                case 'web': {
            		Gifted.reply({ text: 'Visit the Owner Website: https://cool-shot-site.onrender.com/ Join our WhatsApp channel: https://whatsapp.com/channel/0029VbAlmwn8V0tmhrtxSH0x' }, m)
                }
                break;
            }
        } catch (err) {
